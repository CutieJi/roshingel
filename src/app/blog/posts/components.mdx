...
Rosh's Portfolio will replace some default HTML elements to Once UI components to integrate better in the design and add additional functionality. Furthermore, many common Once UI components are already imported and available for use.
...
<CodeBlock
    ...
    <Row fillWidth horizontal="center">
      <Card
        ...
        gap="8"
      >
        <Media src="/images/projects/project-01/cover-01.png" aspectRatio="16/9" radius="l" sizes="400px" />
...
<CodeBlock
    ...
    topRadius="l"
    codeHeight={24}
    preview={<Media src="/images/projects/project-01/cover-01.png" alt="Example image" sizes="640px" aspectRatio="16/9" radius="l" />}
    codes={[
      {
        code:
`<Media
...
Since Rosh's Portfolio is based on Once UI, you can use all the components provided by Once UI in the `.mdx` files, but you need to import them first in the `src/product/mdx.tsx` file and pass it to the `components` object.
