---
title: "Updating the content of Rosh's Portfolio"
...
`const home = {
    ...
    description: "Portfolio website showcasing my work as a Fullstack Engineer",
    headline: <>Fullstack engineer and builder</>,
    subline: (
      <>
        I'm Rosh, a fullstack engineer at <InlineCode>FLY</InlineCode>, where I craft intuitive
