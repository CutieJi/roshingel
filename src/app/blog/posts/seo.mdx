---
title: "SEO settings for Rosh's Portfolio"
summary: "Manage your Portfolio's SEO settings."
...
Rosh's Portfolio automatically generates meta- and open graph tags for your pages based on the `content.js` file.

## Schema

Rosh's Portfolio automatically generates schema tags for your pages based on the `content.js` file.
